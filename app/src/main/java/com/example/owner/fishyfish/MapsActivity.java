...
public class MapsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       latlon.add(new LatLng(20.005611, -155.834368));
        ...
        latlon.add(new LatLng(20.005611, -155.834368));
        latlon.add(new LatLng(25.005611, -155.834368));
        latlon.add(new LatLng(30.005611, -160.834368));
        latlon.add(new LatLng(40.005611, -140.834368));
    ...
    private void setUpMap() {
        for (int i = 0; i < latlon.size(); i++) {
            mMap.addMarker(new MarkerOptions().position(latlon.get(i)));
        }
    }
}
